...
```{r paged-table, echo=FALSE, eval=FALSE}
# define a method for objects of the class data.frame
# clearly something wrong here
# see https://cran.r-project.org/web/packages/knitr/vignettes/knit_print.html
# or https://rdrr.io/github/ahmohamed/lipidr/f/vignettes/examples/mw_integration.Rmd, which seems to be trying to do the same thing I'm doing
...
You can download this .Rmd file below if you'd like to follow along. I do have a few hidden notes you can disregard. This document is a distill_article, so you may want to change to a html_document to knit. You will also need to delete any image references to properly knit, since you won't have those images.
...
![Figure from https://bradleyboehmke.github.io/HOML/process.html#resampling](cv_HOML.png){width = 60% .external}
