...
At first, we will use the instructions I posted in the [github for collaboration](https://github.com/llendway/github_for_collaboration/blob/master/github_for_collaboration.md) documentation starting at the **Adding collaborators** section. Later in the course, we will talking about adding branches, forking, and maybe a few other things.
